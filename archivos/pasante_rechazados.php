...
$consultaTicketsRechazados = "SELECT COUNT(*) AS total FROM `tickets` WHERE `estado` = 'pendiente'";

$resultrechazados = mysqli_query($connect, $consultaTicketsRechazados);
                    ...
                    <ul class="list-reset flex flex-row md:flex-col pt-3 md:py-3 px-1 md:px-2 text-center md:text-left">
                        ...
                        <li class="mr-3 flex-1">
                            <a href="pasante_pendientes.php" class="block py-1 md:py-3 pl-1 align-middle text-white no-underline hover:text-white border-b-2 border-blue-600">
                                <i class="fas fa-times pr-0 md:pr-3 text-blue-600"></i><span class="pb-1 md:pb-0 text-xs md:text-base text-white md:text-white block md:inline-block">Rechazados</span>
                            </a>
                        </li>
...
$consultaTicketsRechazados = "SELECT * FROM `tickets` WHERE `Estado` = 'rechazado'";
$resultTicketsRechazados = mysqli_query($connect, $consultaTicketsRechazados);

if ($resultTicketsRechazados) {
    ...
    while ($rowTicket = mysqli_fetch_assoc($resultTicketsRechazados)) {
