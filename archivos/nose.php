...
if (isset($_SESSION['email']) && isset($_POST['aula']) && isset($_POST['materia']) && isset($_POST['categoria']) && isset($_POST['mensaje'])) {
    ...
    if ($resultUsuarioID && mysqli_num_rows($resultUsuarioID) == 1) {
        ...
        $cabeza .= "Content-Type: text/plain";

        $message ="Este mensaje fue enviado por: " . $name . " \r\n";
        $message .="Su e-mail es: " . $mail . " \r\n";
        $message .="Mensaje: " . $mensaje . " \r\n";
        $message .="Enviado el: " . $fechaCreacion . " \r\n";

        $destinatario = 'ianlucero2006@gmail.com';
        $asunto = 'Solicitudes Sistema de Tickets';

        mail($destinatario, $asunto, $message, $cabeza);
